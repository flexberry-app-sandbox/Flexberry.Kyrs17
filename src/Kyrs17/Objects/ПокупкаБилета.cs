...
namespace IIS.Kyrs17
{
    ...
    [View("ПокупкаБилетаE", new string[] {
            ...
            "ВарПолучБилет as \'Вар получ билет\'",
            "Покупатель as \'Покупатель\'",
            "Покупатель.ФИО as \'ФИО\'",
            "БилетКасса as \'Билет касса\'",
            "БилетКасса.Наименование as \'Наименование\'"}, Hidden=new string[] {
            "Покупатель.ФИО",
    ...
    public class ПокупкаБилета : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kyrs17.Вариант fВарПолучБилет;
        
        private IIS.Kyrs17.Покупатель fПокупатель;
        
        private IIS.Kyrs17.БилетКасса fБилетКасса;
        
        private IIS.Kyrs17.DetailArrayOfИнформация fИнформация;
        ...
        public virtual IIS.Kyrs17.Вариант ВарПолучБилет
        {
            get
            {
                ...
                IIS.Kyrs17.Вариант result = this.fВарПолучБилет;
        ...
        [PropertyStorage(new string[] {
                "Покупатель"})]
        [NotNull()]
        public virtual IIS.Kyrs17.Покупатель Покупатель
        {
            get
            {
                ...
                IIS.Kyrs17.Покупатель result = this.fПокупатель;
        ...
        public virtual IIS.Kyrs17.DetailArrayOfИнформация Информация
        {
            get
            {
                ...
                {
                    this.fИнформация = new IIS.Kyrs17.DetailArrayOfИнформация(this);
                }
                IIS.Kyrs17.DetailArrayOfИнформация result = this.fИнформация;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПокупкаБилетаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПокупкаБилетаE", typeof(IIS.Kyrs17.ПокупкаБилета));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПокупкаБилетаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПокупкаБилетаL", typeof(IIS.Kyrs17.ПокупкаБилета));
                }
            }
        }
    }
